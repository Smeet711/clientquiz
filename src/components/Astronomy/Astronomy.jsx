...
// to randomize the question fetching
  ...
  return (
    <div className="  sm:h-[100vh]  h-[150vh]   flex flex-col w-screen px-5  bg-blue-500 justify-center items-center" style={customStyles}>
...
<Clock/>
 ...
 <div className="flex justify-center w-full mt-4 text-white">
            <div className="flex justify-center w-full mt-4 space-x-4">
              ...
              <button
                onClick={handleNext}
                className={`w-[150px] py-3 bg-indigo-600 font-medium rounded-lg text-white`}
              >
