...
//changes done 
  ...
  return (
    ...
    <div className=" sm:h-[100vh]  h-[110vh]   flex flex-col w-screen px-5  bg-blue-500 justify-center items-center" style={customStyles}>
...
{/* {questions} */}
      ...
      {questions.length > 0 && currentQuestion < questions.length && (
        <div className="flex flex-col  justify-center items-center  w-full">
          ...
          <div className="mt-0 text-xl  text-white text-center">
